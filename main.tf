...
module "state" {
  ...
  source = "git@github.com:padok-team/terraform-azurerm-storage-account.git?ref=v0.2.2"
...
module "network" {
  source = "git@github.com:padok-team/terraform-azurerm-network.git?ref=v0.3.1"
